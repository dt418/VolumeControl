...
"[Blacklist]`n"
"; CtrlAlt / CapsLock — No conflicts. Leave empty.`n"
"; Alt   → recommend: Code.exe, idea64.exe, webstorm64.exe, phpstorm64.exe, sublime_text.exe, notepad++.exe, cursor.exe`n"
"; Ctrl  → recommend: chrome.exe, msedge.exe, firefox.exe, brave.exe, opera.exe, vivaldi.exe, Code.exe, idea64.exe, webstorm64.exe, phpstorm64.exe, sublime_text.exe, notepad++.exe, cursor.exe, WindowsTerminal.exe`n"
"; Or use tray → 🛡️ Apply Recommended Blacklist to auto-fill.`n"
"Apps =`n`n"
"[Beep]`n"
"Enabled = true`n"
"BlockedFreq = 400`n"
